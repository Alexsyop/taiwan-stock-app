...
def _default_events(year, month):
    ...
    events=[
        {"date":f"{pfx}-05","title":"美國非農就業","detail":"美國勞工部公布非農就業人口數據",
         "category":"美國總經","impact":"neutral","impact_zh":"中性","reason":"若高於預期可能引發升息預期，利空科技股"},
        {"date":f"{pfx}-10","title":"美國CPI通膨","detail":"美國消費者物價指數公布",
         "category":"美國總經","impact":"bearish","impact_zh":"利空","reason":"通膨超預期將強化Fed維持高息立場，壓抑成長股"},
        {"date":f"{pfx}-15","title":"台積電法說會","detail":"台積電季度財報及展望說明會",
         "category":"企業財報","impact":"bullish","impact_zh":"利多","reason":"台積電財報是台股最重要風向球"},
        {"date":f"{pfx}-20","title":"Fed FOMC會議","detail":"聯準會利率決策會議",
         "category":"美國總經","impact":"neutral","impact_zh":"中性","reason":"市場最關注Fed利率走向"},
        {"date":f"{pfx}-25","title":"台灣央行理監事會","detail":"台灣央行利率決策會議",
         "category":"台灣財經","impact":"neutral","impact_zh":"中性","reason":"央行政策影響台幣走勢與資金流向"},
    ]
